...
class Dial(Controller):
    ...
    def launch_app(self, app_name: str, callback: Callable[[None], Response]=None, **kwargs) -> None:
        '''
    ...
    def kill_app(self, app_name: str=None, callback: Callable[[None], Response]=None) -> None:
        '''
